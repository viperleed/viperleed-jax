...
def fe2o3_unrelaxed_raw_phaseshifts(
    fe2o3_unrelaxed_state_after_init, fe2o3_unrelaxed_input_path
):
    slab, rpars = fe2o3_unrelaxed_state_after_init
    _, raw_phaseshifts, _, _ = readPHASESHIFTS(
        slab, rpars, fe2o3_unrelaxed_input_path / 'PHASESHIFTS'
    )
...
def test_phaseshift_site_el_order(fe2o3_unrelaxed_state_after_init):
    ...
    assert (
        phaseshift_site_el_order(*fe2o3_unrelaxed_state_after_init)
        == expected_site_el_order
    )
