...
def stored_propagator_reference_values():
    ...
    return (
        np.load(file)["propagator_reference_values_l_max_18_e_1e0_v_imag_1e0"],
        18,
        1.0,
        1.0,
    )
...
def stored_propagator_energy_jacobians():
    ...
    return (
        np.load(file)[
            "propagator_reference_energy_jac_values_l_max_8_e_1e0j_v_imag_1e0"
        ],
        8,
        1.0 + 0.0j,
        1.0,
...
def stored_propagator_disp_jacobians():
    ...
    return (
        np.load(file)[
            "propagator_reference_displacement_jac_values_l_max_8_e_1e0_v_imag_1e0"
        ],
        8,
        1.0 + 0.0j,
        1.0,
