...
def test_iteration_min_max_observed(rng, bounds):
    """
...
def test_permutation_equivariance(rng):
    """
...
def test_equivalent_x_yield_equivalent_c(rng):
...
def test_temperature_effect_entropy(rng):
    """
...
def test_grad_defined_interior():
    """
    ...
    upper = np.ones(d, dtype=np.float64)  # effectively no caps; pure simplex
...
def test_handles_extreme_x_with_zeros_ones():
    """
...
def test_sum_lower_equals_one_returns_lower():
    """
